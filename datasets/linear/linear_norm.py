...
# data generation
generation = dict(generator='LinearNormalDataGenerator',  # data generator
                  n_samples_range=[10000, 10000],  # range of sample size
                  iv_strength_range=[1.0, 2.0],  # range of instrument strength
                  conf_strength_range=[0.0, 1.0],  # range of confounder strength
                  treat_effect_range=[-2.0, 2.0],  # range of treatment effect
